...
<body>
    ...
    <div class="container mt-3">
        ...
        <form action="/cwh_php/Video-21.php" method="post">
...
<!-- NOTES OF GET METHOD AND POST METHOD: -->
...
Tip: You can refer to https://getbootstrap.com/docs/4.5/getting-started/introduction/ to get the Responsive Forms, Alert boxes, and much more codes for your webpage.
-->